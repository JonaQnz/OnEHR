...
export function WidgetDataCard({ block, state, onPick }: { block: CompositionDataBlock; state?: WidgetDataState; onPick?: (row: Record<string, unknown>) => void }) {
