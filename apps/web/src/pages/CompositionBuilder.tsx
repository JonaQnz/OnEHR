...
type WidgetDefinition = { id: string; widgetId?: string; title: string; aqlFunctionId?: string; available: boolean; columns: { value: string; label?: string; time?: string }; chart: { type: 'line' | 'area' | 'bar' | 'metric' | 'table' | 'text' | 'matrix' | 'timeline' } };
